...
VALUES ('BCN-ES','Barcelona','España','Barcelona','08019','+34 93 3561182','Avenida Diagonal, 38','3A escalera Derecha'),
...
VALUES (1,'Marcos','Magaña','Perez','3897','marcos@jardineria.es','TAL-ES',NULL,'Director General'),
...
VALUES (1,'GoldFish Garden','Daniel G','GoldFish','5556901745','5556901746','False Street 52 2 A',NULL,'San Francisco',NULL,'USA','24006',19,3000),
...
SELECT nombre, apellido1, apellido2, puesto FROM empleado WHERE puesto != 'Representates Ventas';

-- Devuelve un listado con el nombre de los todos los clientes españoles.
SELECT nombre_cliente FROM cliente WHERE ciudad IN ('Madrid', 'Barcelona'); 
...
SELECT * FROM pedido WHERE YEAR (fecha_esperada)= 2009;
...
select  e.nombre as nombre_empleado, j.nombre as nombre_jefe, j2.nombre as nombre_jefe2  from empleado j inner join empleado e on j.codigo_empleado=e.codigo_jefe inner join empleado j2 on j.codigo_jefe=j2.codigo_empleado ;