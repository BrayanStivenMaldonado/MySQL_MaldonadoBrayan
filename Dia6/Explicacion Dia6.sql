...
-- ¿Qué es una función deterministica y una función no deterministica?

-- Función Deterministica: Siempre devuelven el mismo resultado para un conjunto dado de parámetros de entrada.
...
DELIMITER //
CREATE FUNCTION valorRandom(valor DECIMAL(10,2))
RETURNS DECIMAL (10,2) DETERMINISTIC
BEGIN
	RETURN valor + (valor * RAND());
END //
DELIMITER ;

select valorRandom(12);
